function efa_t4iss(datafile,nf)
...
nfdif= 'n'; %input('Other num. of factors to be considered:? (y/n)','s');
...
save -7 efa.mat xbackward ebl xforward efl   d e eforward ebackward  Energy




disp('Evolving factor analysis - EFA - is complete...')
